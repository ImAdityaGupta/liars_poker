...
PHASES: list[dict[str, Any]] = [
    {
        "name": "p0_lr_1e-3_trav1024_cap16",
        "learning_rate": 1e-3,
    ...
    {
        "name": "p1_lr_1e-3_trav1024_cap24",
        "learning_rate": 1e-3,
        "traversals_per_player": 1024,
        "regret_train_steps": 24,
        "strategy_train_steps": 6,
    ...
    {
        "name": "p2_lr_3e-4_trav1024_cap24",
        "learning_rate": 3e-4,
        "traversals_per_player": 1024,
        "regret_train_steps": 24,
        "strategy_train_steps": 6,
    ...
    {
        "name": "p3_lr_1e-4_trav2048_cap24",
        "learning_rate": 1e-4,
    ...
    {
        "name": "p4_lr_3e-5_trav4096_cap24",
        "learning_rate": 3e-5,
    ...
    {
        "name": "p5_lr_3e-5_trav4096_cap24_strategy12",
        "learning_rate": 3e-5,
        "traversals_per_player": 4096,
        "regret_train_steps": 24,
...
TRAINER_KWARGS: dict[str, Any] = {
    ...
    "traverser_action_sample_schedule": (16,),
