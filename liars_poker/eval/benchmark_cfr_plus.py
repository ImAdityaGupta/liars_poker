...
from liars_poker.training.cfr_plus_dense import cfr_plus_loop, cfr_plus_resume, save_cfr_plus_run
...
def main():
    ...
    while remaining > 0:
        ...
        if first_chunk:
            ...
            policy, logs, cfr, spec, total_iters = cfr_plus_resume(
                run_dir,
